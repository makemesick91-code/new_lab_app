...
class UpdateWaReminderTemplateRequest extends FormRequest
{
    ...
    {
        $templateId = $this->route('waReminderTemplate')?->id;
        ...
        return [
            'code' => [
                ...
                'string',
                'max:50',
                Rule::unique('mst_wa_reminder_templates', 'code')->ignore($templateId),
            ],
