    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator): void {
            ...
            if ($goodsReceipt->isPosted() || $goodsReceipt->posted_at !== null) {
                $validator->errors()->add('goods_receipt', 'Penerimaan barang yang sudah diposting tidak dapat dibatalkan.');
            }

            if (! $goodsReceipt->isDraft()) {
                $validator->errors()->add('goods_receipt', 'Hanya penerimaan barang draft yang dapat dibatalkan.');
            }
        });
    }
