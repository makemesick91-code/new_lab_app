...
trait ValidatesPurchaseOrderInput
{
    ...
    protected function purchaseOrderInputRules(): array
    {
        return [
            ...
            'items.*.supplier_id' => ['required', 'integer', 'exists:inv_suppliers,id'],
    ...
    protected function purchaseOrderInputMessages(): array
    {
        return [
            ...
            'items.*.supplier_id.required' => 'Supplier wajib dipilih untuk setiap item.',
            'items.*.supplier_id.exists' => 'Supplier tidak ditemukan.',
            'items.*.estimated_arrival_date.required' => 'Estimasi tanggal barang datang wajib diisi untuk setiap item.',
            'items.*.estimated_arrival_date.date' => 'Estimasi tanggal barang datang tidak valid.',
            'items.*.estimated_arrival_date.after_or_equal' => 'Estimasi tanggal barang datang tidak boleh sebelum tanggal pesanan.',
