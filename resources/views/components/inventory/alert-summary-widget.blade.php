...
>
    <div class="grid gap-3 sm:grid-cols-2 xl:grid-cols-5">
        <div class="rounded-lg border border-rose-100 bg-rose-50 p-3">
            ...
            <p class="mt-1 text-2xl font-semibold tabular-nums text-rose-900">{{ format_number_id((int) $summary['out_of_stock_count']) }}</p>
        </div>
        ...
        <div class="rounded-lg border border-amber-100 bg-amber-50 p-3">
            ...
            <p class="mt-1 text-2xl font-semibold tabular-nums text-amber-900">{{ format_number_id((int) $summary['low_stock_count']) }}</p>
        </div>
        <div class="rounded-lg border border-rose-100 bg-rose-50 p-3">
