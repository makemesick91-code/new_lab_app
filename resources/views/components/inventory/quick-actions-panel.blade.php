    ...
    <div class="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
        @can('create', \App\Modules\Inventory\Models\PurchaseRequest::class)
            <a
                ...
                class="rounded-lg border border-gray-200 p-3 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2"
        ...
        @can('viewAny', \App\Modules\Inventory\Models\InventoryMovement::class)
            <a
                ...
                class="rounded-lg border border-brand-200 bg-brand-50 p-3 text-sm font-medium text-brand-800 hover:bg-brand-100 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2"
