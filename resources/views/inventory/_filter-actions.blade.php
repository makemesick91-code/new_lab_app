...
<div {{ $attributes->merge(['class' => 'flex flex-col gap-2 sm:flex-row md:col-span-2 xl:col-span-3 xl:items-end xl:justify-end']) }}>
    ...
    <a href="{{ $resetUrl }}" class="inline-flex w-full justify-center rounded-lg border border-gray-200 px-4 py-2 text-sm font-semibold text-gray-600 hover:bg-gray-50 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 sm:w-auto">
        Atur Ulang
    </a>
</div>
