<x-settings-shell title="Edit Product">
    <div class="bg-white shadow-sm sm:rounded-lg p-6">
        <form method="POST" action="{{ route('inventory.products.update', $product) }}" class="space-y-5">
            ...
            <div class="flex items-center justify-end gap-2">
                ...
                <button class="rounded-md bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-500">Update Product</button>
            </div>
        </form>
    </div>
</x-settings-shell>
