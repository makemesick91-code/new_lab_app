<x-settings-shell title="Edit Lab Service">
    <div class="bg-white shadow-sm sm:rounded-lg">
        <form method="POST" action="{{ route('settings.lab-services.update', $labService) }}" class="p-6 space-y-6">
            ...
            <div class="flex items-center gap-3">
                <button type="submit" class="inline-flex items-center rounded-md bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-500">Update Lab Service</button>
