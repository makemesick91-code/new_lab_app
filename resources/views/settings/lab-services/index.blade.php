        ...
        <div class="p-6 space-y-4">
            <div class="flex flex-wrap items-center justify-between gap-3">
                <form method="GET" action="{{ route('settings.lab-services.index') }}" class="flex items-center gap-2">
                    ...
                    @if ($search)<a href="{{ route('settings.lab-services.index') }}" class="text-sm text-gray-500 hover:text-gray-700">Atur Ulang</a>@endif
                </form>
                            ...
                            <tr>
                                ...
                                <td class="px-3 py-2">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('settings.lab-services.edit', $service) }}" class="text-indigo-600 hover:text-indigo-500">Ubah</a>
                                        @if ($service->is_active)
