...
{{-- Safety notice --}}
<div class="rounded-md border border-warning-100 bg-warning-50 p-4 text-sm text-warning-700">
...
<div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
    ...
    <div>
        ...
        <select name="trigger_type" class="mt-1 block w-full rounded-md border-gray-300 text-sm focus:border-brand-500 focus:ring-brand-500">
        ...
        @error('trigger_type')<p class="mt-1 text-xs text-danger">{{ $message }}</p>@enderror
    </div>
    <div>
        <label class="block text-sm font-medium text-gray-700">Audiens</label>
        <select name="audience_type" class="mt-1 block w-full rounded-md border-gray-300 text-sm focus:border-brand-500 focus:ring-brand-500">
        ...
        @error('audience_type')<p class="mt-1 text-xs text-danger">{{ $message }}</p>@enderror
    </div>
    <div>
    ...
    <div class="sm:col-span-2">
        ...
        <div class="mt-1 rounded-md border border-info-100 bg-info-50 p-3 text-xs text-info-700 mb-1">
        ...
        @error('message_body')<p class="mt-1 text-xs text-danger">{{ $message }}</p>@enderror
    </div>
    <div class="sm:col-span-2">
    ...
    <div class="sm:col-span-2">
        ...
        <textarea name="description" rows="2"
                  class="mt-1 block w-full rounded-md border-gray-300 text-sm focus:border-brand-500 focus:ring-brand-500">{{ old('description', $template?->description) }}</textarea>
