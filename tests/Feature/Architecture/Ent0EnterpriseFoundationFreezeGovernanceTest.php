...
it('registers ENT-0..ENT-3 completed and ENT-6..ENT-16 planned in the canonical roadmap', function () {
...
it('next recommended sprint is ENT-6 and is not stale after the cache policy lock', function () {
