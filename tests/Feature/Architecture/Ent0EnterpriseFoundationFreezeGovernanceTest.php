...
it('registers ENT-0..ENT-3 completed and ENT-7..ENT-16 planned in the canonical roadmap', function () {
...
it('next recommended sprint is ENT-7 and is not stale after the cache policy lock', function () {
