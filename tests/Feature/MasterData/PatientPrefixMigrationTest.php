...
it('migrates RM DG patient numbers to DG without touching existing DG numbers', function () {
    $legacy = Patient::factory()->create(['medical_record_number' => 'RM DG-TKM1-2026-0001']);
    ...
    expect($legacy->refresh()->medical_record_number)->toBe('DG-TKM1-2026-0001')
...
it('skips RM to DG migration when the target number already exists', function () {
    ...
    expect($legacy->refresh()->medical_record_number)->toBe('RM DG-TKM1-2026-0001');
});
